    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.CharField(choices=[('brith_date', 'Bronze'), ('S', 'Silver'), ('G', 'Gold')], default='brith_date', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cusoter', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='store.customer')),
            ],
        ),
        migrations.CreateModel(
            name='Product',
